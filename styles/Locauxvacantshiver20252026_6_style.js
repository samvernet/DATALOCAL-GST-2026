var size = 0;
var placement = 'point';
function categories_Locauxvacantshiver20252026_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement, textAlign, offsetX, offsetY, overflow, repeat) {
    var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
    switch(valueStr) {
        case 'Locaux en travaux':
...
var style_Locauxvacantshiver20252026_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Catégories hiver 2025");
    ...
    var style = categories_Locauxvacantshiver20252026_6(feature, value, size, resolution, labelText,
