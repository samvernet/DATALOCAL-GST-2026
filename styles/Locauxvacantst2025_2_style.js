var size = 0;
var placement = 'point';
function categories_Locauxvacantst2025_2(feature, value, size, resolution, labelText,
...
var style_Locauxvacantst2025_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Catégories été 2025");
    ...
    var style = categories_Locauxvacantst2025_2(feature, value, size, resolution, labelText,
