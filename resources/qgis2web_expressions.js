...
function exp_label_EnseignesNationales_4_eval_expression(context) {
    // Etablissem
...
function exp_label_Notesdevantureshiver20252026_5_eval_expression(context) {
    // Etablissem
...
function exp_Emplacementn1_7rule0_eval_expression(context) {
    // Empl = 1
